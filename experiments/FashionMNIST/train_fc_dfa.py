...
# Hidden layer
N_NEURONS_1 = 400
TAU_S_1 = 0.130  # 100 ms
THRESHOLD_HAT_1 = 0.2
SPIKE_BUFFER_SIZE_1 = 30

N_NEURONS_2 = 400
TAU_S_2 = 0.130  # 100 ms
THRESHOLD_HAT_2 = 0.2
SPIKE_BUFFER_SIZE_2 = 30

# Output_layer
N_OUTPUTS = 10
TAU_S_OUTPUT = 0.130  # 100 ms
...
REG_FACTOR_1 = 1.0
MEAN_FR_TARGET_1 = 0.4
REG_FACTOR_2 = 1.0
MEAN_FR_TARGET_2 = 0.4
TARGET_FALSE = 3
TARGET_TRUE = 15
KERNEL_TYPE = "STD"
...
# Plot parameters
EXPORT_DIR = Path("./results/random_dfa/" + KERNEL_TYPE + "/")

"""
89.35, 89.41, 89.47, 89.6, 89.23
"""
...
def main(export_dir: Path):
    ...
    hidden_layer_2 = LIFLayer(previous_layer=hidden_layer, n_neurons=N_NEURONS_2, n_outputs=N_OUTPUTS,
                            ...
                            mean_fr_target=MEAN_FR_TARGET_2,
                            normalize_grad=NORMALIZE_GRAD,
                            kernel_type=KERNEL_TYPE)
    network.add_layer(hidden_layer_2)

    output_layer = LIFLayer(previous_layer=hidden_layer_2, n_neurons=N_OUTPUTS, n_outputs=N_OUTPUTS,
                            tau_s=TAU_S_OUTPUT,
