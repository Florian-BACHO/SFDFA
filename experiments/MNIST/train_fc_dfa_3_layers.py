...
N_INPUTS = 28 * 28
SIMULATION_TIME = cp.inf

# Hidden layer
N_NEURONS_1 = 800
TAU_S_1 = 0.010  # 10 ms
THRESHOLD_HAT_1 = 1.5 * 2 * TAU_S_1
SPIKE_BUFFER_SIZE_1 = 30

N_NEURONS_2 = 800
TAU_S_2 = 0.010  # 10 ms
THRESHOLD_HAT_2 = 1.5 * 2 * TAU_S_2
SPIKE_BUFFER_SIZE_2 = 30

N_NEURONS_3 = 800
TAU_S_3 = 0.010  # 10 ms
THRESHOLD_HAT_3 = 1.5 * 2 * TAU_S_3
SPIKE_BUFFER_SIZE_3 = 30

# Output_layer
N_OUTPUTS = 10
TAU_S_OUTPUT = 0.010  # 10 ms
THRESHOLD_HAT_OUTPUT = 4.0 * 2 * TAU_S_OUTPUT
...
# Plot parameters
EXPORT_DIR = Path("./results/random_dfa_3_layers/" + KERNEL_TYPE + "/")
...
REG_FACTOR = 1.2
NORMALIZE_GRAD = True
97.97 (Numpy seed: 1908140966, Cupy seed: 1997536397)
"""
...
REG_FACTOR = 1.2
NORMALIZE_GRAD = True
97.93 (Numpy seed: 1959579012, Cupy seed: 1184540953)
"""
...
97.90 (Numpy seed: 1277516942, Cupy seed: 2066617535)
"""
...
def feedback_initializer_random_dfa(n_hidden: int, n_outputs: int) -> cp.ndarray:
    return cp.random.uniform(-1.0, 1.0, size=(n_hidden, n_outputs), dtype=cp.float32)


def feedback_initializer_binary_dfa(n_hidden: int, n_outputs: int) -> cp.ndarray:
    return cp.random.choice(cp.array([0.0, 1.0], dtype=cp.float32), size=(n_hidden, n_outputs))
...
def main(export_dir: Path):
    ...
    hidden_layer = LIFLayer(previous_layer=input_layer, n_neurons=N_NEURONS_1, n_outputs=N_OUTPUTS,
                            ...
                            feedback_initializer=feedback_initializer_random_dfa,
                            max_n_spike=SPIKE_BUFFER_SIZE_1,
                            name="Hidden layer 1",
                            reg_factor=REG_FACTOR,
                            mean_fr_target=MEAN_FR_TARGET,
    ...
    hidden_layer_3 = LIFLayer(previous_layer=hidden_layer_2, n_neurons=N_NEURONS_3, n_outputs=N_OUTPUTS,
                            tau_s=TAU_S_3,
    ...
    output_layer = LIFLayer(previous_layer=hidden_layer_3, n_neurons=N_OUTPUTS, n_outputs=N_OUTPUTS,
                            tau_s=TAU_S_OUTPUT,
