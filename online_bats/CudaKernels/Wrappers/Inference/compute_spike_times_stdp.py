...
KERNEL_FILE = "Inference/compute_spike_times_stdp.cu"
KERNEL_NAME = "compute_spike_times_kernel"

__compute_spike_times_kernel = load_kernel(KERNEL_FILE, KERNEL_NAME)

def compute_spike_times_stdp(spike_indices: cp.ndarray, spike_times: cp.ndarray,
    ...
    args = (spike_indices, spike_times, exp_tau_s, exp_tau, pre_dir_derivatives, weights, perturbations,
            ...
            n_spikes, post_spike_times, post_dir_derivatives, trace_a, eligibility_trace)
